                ...
                for (const [, attachment] of attachments) {
                    ...
                    try {
                        ...
                        await logsChannel.send({
                            ...
                            content: `${languageStrings.DELETED_ATTACHMENT || 'Deleted attachment'}: ${attachment.name}`,
                        ...
                        await logsChannel.send({
                            ...
                            content: `${languageStrings.ATTACHMENT_ERROR || 'Could not download attachment'}: ${attachment.name}\n${attachment.url}`
                    ...
                    try {
                        ...
                        if (sticker.url) {
                            ...
                            await logsChannel.send({
                                ...
                                content: `${languageStrings.DELETED_STICKER || 'Deleted sticker'}: ${sticker.name}`,
                        ...
                        await logsChannel.send({
                            ...
                            content: `${languageStrings.STICKER_ERROR || 'Could not download sticker'}: ${sticker.name}\n${sticker.url}`
